...
public class TampilSemuaPgw extends AppCompatActivity {
    ...
    private void showEmployee() {
        ...
        ListAdapter adapter = new SimpleAdapter(TampilSemuaPgw.this, list, R.layout.list_item, new String[]{Configuration.TAG_ID, Configuration.TAG_NAMA}, new int[]{R.id.tv_id, R.id.tv_nama});
